...
class BaseTool(ABC):
    ...
    def _create_success_response(self, data:Optional[Dict[str, Any]] = None, request_params: Optional[Dict[str,Any]] = None):
        self.logger.debug(f"Action successful. Data: {str(data)[:200]}...")
        return ToolResponse(status="success", data=data, error_message=None)
    
    def _create_error_response(self, error_message: str, request_params: Optional[Dict[str, Any]] = None) -> ToolResponse:
